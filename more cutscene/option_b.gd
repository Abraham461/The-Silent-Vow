...
# Preload all images
var textures = [
	preload("res://more cutscene/Image_for_options/OptionB.png"),
	preload("res://more cutscene/Image_for_options/OptionB.png")
]
...
func enqueue_cutscenes():
	...
	queue_pair("Elira abdicates the throne. She leaves at dawn, wearing Zakcoff’s cloak and carrying his sword. ", textures[0])
	queue_pair("She vanishes into legend, helping rebuild villages, quietly watching over Eirenwald like a ghost.  ", textures[1])

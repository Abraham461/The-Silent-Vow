...
#@onready var health: SlimeDemonHealth = $"../SlimeDemonHealth"
@onready var health: MalrikHealth = $"../MalrikHealth"

#@onready var health: Health = $"../Health"

#@onready var enemy: AnimatedSprite2D = $"../Enemy"
#@onready var enemy: AnimatedSprite2D = $"../AnimatedSprite2D"
#@onready var enemy: AnimatedSprite2D = $"../SlimeDemon"
@onready var enemy: AnimatedSprite2D = $"../Malrik"
...
#@onready var deathani: AnimatedSprite2D = $"../SlimeDemon"
#@onready var deathani: AnimatedSprite2D = $"../AnimatedSprite2D"
@onready var deathani: AnimatedSprite2D = $"../AnimatedSprite2D"
...
func _on_health_depleted() -> void:
	...
	get_tree().change_scene_to_file("res://chapter_3_1Third.tscn")
